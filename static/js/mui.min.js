...
//  外网
var beforePath = 'https://commerce.hh-sky.com/'

//  通讯地址
// var beforePath = 'http://12.10.60.222/GL_Commercial_Street/'
//  管理接口路径
var shopManagePath = 'public/index.php/shopping/Shopmanagement/'

var URL = beforePath + shopManagePath

//  图片路径
var PicPath = beforePath + 'public/static/images/'

//  登录接口
var loginPath = beforePath + 'public/index.php/shopping/Registration/'

// 商品图片地址  PicPath + 'goods_image/'

//  商店背景图  PicPath + 'shop_back_image/'

//  商店头像  PicPath + 'shop_image/'
...
function setOpenWindow(url, id, tit, view) {
	if(view == 'titleNView') {
		titleNView.titletext = tit
		setopenstyle = setStyle
	} else if(view == 'settingTitleNView') {
		settingTitleNView.titletext = tit
		setStyle.titleNView = settingTitleNView
		setopenstyle = setStyle
	} else {
		titleNView.titletext = tit
		setopenstyle = {
	...
	setTime++
	if(setTime < 2) {
		plus.webview.open(url, id, setopenstyle, 'slide-in-right', 200);
		setTimeout(() => {
			setTime = 0
		}, 1000);
	}
...
function setCreateWindow(url, id, tit, view) {
	if(view == 'titleNView') {
		titleNView.titletext = tit
		setopenstyle = setStyle
	} else if(view == 'settingTitleNView') {
	...
	setTime++
	if(setTime < 2) {
		let a = plus.webview.open(url, id, setopenstyle, 'slide-in-right', 200);
		setTimeout(() => {
			setTime = 0
		}, 1000);
		return a;
