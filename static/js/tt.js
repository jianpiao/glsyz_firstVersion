...
//webview方式组件载入  实现相对流畅一点的滚动条动画和左右滑动切换页面的动画效果
...
proto._initNativeView = function () {
    this.nativeView = new plus.nativeObj.View('__MUI_TAB_NATIVE', {
        'top': '128px',//这个需要根据顶部导航及顶部选项卡高度自动调整
        'bottom': '50px',
...
mui.plusReady(function () {
    var group = new webviewGroup(plus.webview.currentWebview().id, {
        items: [{
            id: "components/waiting.html",
            url: "components/waiting.html",
            extras: {}
        }, {
            id: "components/done.html",
            url: "components/done.html",
            extras: {}
        }],
